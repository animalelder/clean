    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto">
        ...
        <h2 className="mx-auto mb-8 max-w-3xl text-xl font-bold">
          The journey to godly manhood isn't meant to be walked alone. These men
          found victory through{" "}
        ...
        <p className="mx-auto mb-8 max-w-2xl">
          ...
          and transformation reveal how God's truth and supportive community can
          restore marriages, protect families, and renew purpose.
        </p>
